...
import watchtower
import boto3
from config.config import LOG_DIR, JOB_ID, ENV, CLOUDWATCH_LOG_GROUP
...
try:
    ...
    logger.warning("CloudWatch logging unavailable — continuing with stdout+file logging: %s", _cw_err)
